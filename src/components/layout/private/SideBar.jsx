    ...
    return (
        <aside className="layout__aside">
            ...
            <header className="aside__header">
                <h1 className="aside__title">Hola, {auth.name} {auth.surename}</h1>
            </header>
            ...
            <div className="aside__container">
                ...
                <div className="aside__profile-info">
                    ...
                    <div className="profile-info__general-info">
                        ...
                        <div className="general-info__container-names">
                            <Link to={'/social/perfil/' + auth._id} className="container-names__name">{auth.name} {auth.surename}
                            </Link>
                ...
                <div className="aside__container-form">
                    ...
                    {stored == 'error' ?
                        <strong className='alert alert-danger'> No se ha publicado !!</strong> : ''}
                    ...
                    <form id='publication-form' className="container-form__form-post" onSubmit={savePublication}>
                        ...
                        <div className="form-post__inputs">
                            ...
                            <textarea text="text" name="text" className="form-post__textarea" onChange={changed} />
                        </div>
